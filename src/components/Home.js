...
import Challenge1MobileDesign from "../ProfileCard/design/desktop-design.jpg";

const Home = () => {
  return (
    <div
      role="listitem"
      className="min-h-screen bg-gradient-to-tl from-gray-400 via-gray-50 to-gray-400"
    >
      <div
        role="contentinfo"
        className="bg-blue-900 p-6 border-b-2 border-black"
      >
