  ...
  return (
    <div className="main min-w-full min-h-screen ">
      <div className="flex sm:flex-row flex-col-reverse justify-center items-center p-7 pt-20 pb-24 sm:pt-40 sm:pb-40 sm:p-40 ">
        <div className=" bg-blue-1100 p-10 h-auto rounded-b-md sm:pt-14 sm:rounded-b-none sm:rounded-l-md sm:h-80 sm:w-96">
          ...
          <div className="flex flex-col items-center space-y-5 pt-8 sm:space-y-0 sm:flex-row sm:justify-start sm:space-x-9">
