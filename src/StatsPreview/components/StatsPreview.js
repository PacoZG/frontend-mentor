    ...
    <div className=" bg-blue-1400 min-w-full ">
      ...
      <div className="hidden sm:flex flex-row justify-center items-center pt-40 pb-40 ">
        <div className=" bg-blue-1100 p-12 rounded-l-md h-80 w-96">
          ...
          <p className="text-white opacity-50 leading-5 text-2xs text-left pt-3 pr-6">
            Discover the benefits of data analytics and make better decisions
            regarding revenue, customer experience, and overall efficiency.
          </p>
          <div className="flex items-center pt-2 flex-row justify-start space-x-9">
            <div className="flex flex-col items-start">
              <h1 className="text-white text-xl font-semibold">10k+</h1>
              <p className="text-white text-3xs tracking-widest opacity-50 uppercase">
                companies
              </p>
            </div>
            <div className="flex flex-col items-start">
